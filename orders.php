    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="box">
          ...
          <a type="button" class="btn btn-small btn-primary" href="order_cart.php">
              <i class="glyphicon glyphicon-plus"></i>Add Order
          </a><br>   
        <!--<a href="#" id="btnAddroom" class="dropdown-toggle" data-toggle="modal" data-target="#myModalAdd">
              <i class="glyphicon glyphicon-plus"></i>Add Order Line
          </a>-->
...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
       ...
       echo "<tr>";   
            ...
            if ($ol_approve_by_admin == 0) {
              echo "<td class=\" btn-danger\">Pending Order</td>";
          }else if($ol_approve_by_admin == 1){
            ...
            echo "<td><form action=\"\" method=\"post\">";
                      ...
                      echo"<a type=\"button\" href=\"order_details.php?id=" . $order_ID . "&room_ID=".$room_ID."\" class=\"btn btn-small btn-primary\">View Orders</a>";
                    if($ol_approve_by_admin == 0){  
                      echo"<a class = \"fa fa-fw fa-thumbs-o-up\" title=\"Approve Order\" href=\"backend/order_line/order_line_app.php?id=" . $order_ID . "\" onclick=\"return confirm('Confirm Approve?');\"></a> ";
                      echo"<a class = \"fa fa-fw fa-thumbs-o-down\" title=\"Disapprove Order\" href=\"backend/order_line/order_line_disapp.php?id=" . $order_ID . "\" onclick=\"return confirm('Confirm Disapprove?');\"></a> ";      
                    }
            echo"</form>";echo"</td>";        
        echo "</tr>";
