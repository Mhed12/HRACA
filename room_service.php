...
<!--div style="float:left;width:20%"-->
      ...
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Room Service Table</h3>
        </div>
         ...
         <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT p.product_ID, p.product_name FROM product p, room_service rc WHERE p.product_ID = rc.product_ID AND p.product_type = \"room_service\";";
      ...
      while($row = mysqli_fetch_assoc($result)) {
          ...
          if(isset($_POST['submit'])){
                      if($_POST['id'] == $service_ID){
                          //edit
                            echo "<form method=\"post\" action=\"backend/room_service/room_service_edit.php\" enctype=\"multipart/form-data\">";//bagong laag
                            echo "<td><input type=\"text\" placeholder=\"".$service_name."\" id=\"service_name\" name=\"service_name\"></td>";
                        ...
                        <form action=\"\" method=\"post\">
                                      ...
                                      ";
                                        echo"
                                      <a  class = \"fa fa-fw fa-trash-o\" href=\"backend/room_service/room_service_delete.php?id=".$service_ID."\" onclick=\"return confirm('Confirm Delete');\"></a>
          ...
          <div class=\"modal-dialog\">
            <div class=\"modal-content\">
              ...
              <div class=\"modal-body\">
                 ...
                 <!-- form start -->
            <form role=\"form\" action=\"backend/room_service/room_service_insert.php\" method=\"post\" enctype=\"multipart/form-data\">
              <div class=\"box-body\">

              <div class=\"form-group\">
                  <label for=\"product_ID\">Service ID</label>
                  <input type=\"text\" class=\"form-control\" id=\"product_ID\" name=\"product_ID\" placeholder=\"Enter Service ID\"required>
                </div>
              ...
              <div class=\"modal-footer\">
                <button type=\"submit\" name=\"Submit\" class=\"btn btn-primary\" value=\"Submit\">Add Service</button>
              </div>
...
var a = "<?php echo $_GET ["err"];?>";
 ...
 if(a==1){
   a = "Room Service Inserted Successfully";
   alert(a);
 }else if(a==2){
   a = "Room Service Deleted Successfully";
   alert(a);
 }else{
  a = "Room Service Updated Successfully";
   alert(a);
 } 
</script>
 <script>
