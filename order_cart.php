...
?>
    ...
    <BODY>
        ...
        <div id="shopping-cart">
            ...
            <a id="btnEmpty" href="order_cart.php?action=empty" onclick="return confirm('Empty Cart?');">Empty Cart</a>
			<?php
					 if(isset($_SESSION["cart_item"])){
						$total_quantity = 0;
						$total_price = 0;
				?>
		    <form role="form" action="order_cart.php?action=insert" method="post" enctype="multipart/form-data">
                            ...
                            <?php		
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        <a href="order_cart.php?action=remove&product_ID=<?php echo $item["product_ID"]; ?>" class="btnRemoveAction" onclick="return confirm('Remove Meal?');"><img src="icon-delete.png" alt="Remove Item" /></a>
                                    </td>
                                </tr>
                                <?php
                    ...
                    <div class="txt-heading">Room</div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group\">
                            ...
                            <select class="form-control" id="room_ID" name="room_ID" required>
                                <option value="">Select Room - Guest name</option>
                                <?php 
											$room=$db_handle->runQuery("SELECT r.room_ID, b.booking_ID, r.room_name, g.first_name, g.last_name FROM room r, booking b, guest g WHERE r.room_ID = b.room_ID AND b.guest_id = g.guest_id AND b.booking_approve = 1 AND r.room_availability = 0 AND b.status = 1");
											if (!empty($room)) { 
												foreach($room as $key=>$value){
											echo" <option value=".$room[$key]['room_ID']."|".$room[$key]['booking_ID'].">".$room[$key]['room_name']." - ". $room[$key]['first_name']." ".$room[$key]['last_name']."</option>";											
												}
										 	}?>
        ...
        <div id="product-grid">
            ...
            <div class="footer">
                <a type="button" href="orders.php" class="btn btn-primary">Close</a>
            </div>
            <?php
			...
			?>
                <div class="product-item">
                    <form method="post" action="order_cart.php?action=add&product_ID=<?php echo $product_array[$key]["product_ID"]; ?>">
                        ...
                        <div class="product-tile-footer">
                            ...
                            <div class="cart-action">
                                <input type="text" class="product-quantity" name="quantity" min="1" value="1" size="2" />
