      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <a type="button" href="kitchen.php" class="close" aria-label="Close">
          ...
          <h4 class="modal-title">Order List of <b><?php echo $room_name?></b></h4>
            ...
            $sql    = "SELECT p.product_name, f.food_image, f.food_price, ol.quantity, ol.subtotal 
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                   ...
                   echo" <tr>
                            <td>$product_name</td>
                            <td><img width=\"150\" height=\"100\" src='".$food_image."'/></td>
                            <td>$quantity</td>
                            <td>₱$food_price</td>
                            <td>₱$subtotal</td>
                        </tr>";
          ...
          <div class="modal-footer">
                ...
                <a type="button" href="kitchen.php" class="btn btn-primary">Close</a>
              </div>
        <!-- /.box-body -->
